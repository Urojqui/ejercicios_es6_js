/* 6.1 Dado el siguiente array, haz una suma de todas las notas de los examenes de 
...
const sumPass = exams.reduce((acc, exam) => {
  if (exam.score >= 5) {
...
const average = totalScore2 / exams.length;
